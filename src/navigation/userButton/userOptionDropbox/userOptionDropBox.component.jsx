...
const UserOptionDropbox = ({singoutHandler, themeHandler}) => {
    //TODO: get theme handler function from navigation for LightTheme

    const {IslightTheme} = useContext(UserContext);
    return(
        <div className='userOptions_container'>
            <div> <span>Account</span> <AccountIcon className='opions_svg'/> </div>
            ...
            <div> <span>Connections</span> <ConnectionsIcon className='opions_svg'/> </div>
            <div> <span>Settings</span> <SettingsIcon className='opions_svg'/> </div>
